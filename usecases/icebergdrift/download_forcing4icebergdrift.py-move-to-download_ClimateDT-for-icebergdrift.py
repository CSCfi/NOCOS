...
-----
    ...
    python3 ../../lib/desp-authentication.py
...
"""
# Get a Polytope token:
#python 3 /dmidata/users/ang/icebergdrift/code/polytope_examples-git/desp-authentication.py 
...
for year in range(2010,2020):
  ...
  # The start and length of the simulation
  date_start=datetime.date(year,8,14) 
  numdays=49 # number of days to download
  #date_start=datetime.date(year,7,1) 
  #numdays=46 # number of days to download 

  # Region to be processed ("BaffinLabra" for icebergs)
  # Region to be processed ("CoburgLabra" for icebergs)?
  # mapregion='Greenland'
  ...
  datastoragedir='/dmidata/scratch/10day/ang'
  # datastoragedir='/tmp/icebergforcing/'
