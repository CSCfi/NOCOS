...
The Climate Change Adaptation Digital Twin simulations (ClimateDT) offer a great opportunity to assess the expected changes in landfast ice coverage because these simulations feature high spatial resolution which is necessary to adequately resolve the coastal areas. 
...
This use case provides a tool to derive areas covered by landfast ice from ClimateDT simulations. 
