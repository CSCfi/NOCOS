...
#dataICE=request_icedata_boundingbox(activity="ScenarioMIP",experiment="SSP3-7.0",model=climateDTmodel,date=REQ_daterange,param="263001/263003/263004")



dataICE.ls()
dataICExr=dataICE.to_xarray()
...
# The field to plot
plottimestamp=3
fasticetoplot=dataICE[((fasticeduration-1)+plottimestamp)*3].clone(values=canvaswithland[plottimestamp,:], name="Fast ice occurrence", shortName="fastice", units="") # Check metadata with e.g.: fastice.metadata("name")
